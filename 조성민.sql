...
EXECUTE new_pro2('0008093355774');
...
begin
    ...
    into v_mname
    from employees e 
    where employee_id = (select d.manager_id from departments d where lower(department_name) = v_dname);
    
    return v_mname;
end;    
/

EXECUTE DBMS_OUTPUT.PUT_LINE(new_fuc2(lower('&부서이름')));
